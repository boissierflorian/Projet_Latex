...
\input{ducoroy/figures/console_fig}
...
\input{ducoroy/listings/listing_apercu}

\subsection{include}
La toute première ligne est : \partlist{C++}{1-1}{ducoroy/listings/codes/premier_code.cpp}
...
\partlist{C++}{2-2}{ducoroy/listings/codes/premier_code.cpp}
...
\input{ducoroy/listings/listing_codevide}
...
\partlist{C++}{5-5}{ducoroy/listings/codes/premier_code.cpp}
...
\partlist{C++}{6-6}{ducoroy/listings/codes/premier_code.cpp}
...
\partlist{C++}{1-1}{ducoroy/listings/codes/commentaires.cpp}

Mieux, vous pouvez aussi ajouter le commentaire à la fin d'une ligne de code pour expliquer ce qu'elle fait :

\partlist{C++}{2-2}{ducoroy/listings/codes/commentaires.cpp}

\subsubsection{Commentaires longs}

\partlist{C++}{3-6}{ducoroy/listings/codes/commentaires.cpp}
